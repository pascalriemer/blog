...
export default function AdminDashboard() {
  ...
  const handleUpdateContactEmail = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setEmailStatus('error');
      setEmailErrorMessage(error instanceof Error ? error.message : 'An error occurred');
    }
  };
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
                  <div className="px-4 py-5 sm:p-6">
                    <h2 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Contact Form Settings</h2>
                        ...
                        <div className="flex">
                          <div className="ml-3">
                            ...
                            <div className="mt-2 text-sm text-green-700 dark:text-green-300">
                              <p>The contact form email recipient has been updated successfully.</p>
                            </div>
                          </div>
                        </div>
                      </div>
